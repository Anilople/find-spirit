...
public class JudgeUtil {
	...
	public static boolean existEqual(List<Integer> spiritMove, List<Integer> jarOpenStrategy) {
		if (spiritMove.size() != jarOpenStrategy.size()) {
			throw new IllegalArgumentException(
					"list's size should be equal, not " + spiritMove.size() + " and " + jarOpenStrategy.size());
		}
	 ...
	 */
	public static boolean existEqualInAll(List<Integer> jarOpenStrategy, List<List<Integer>> spiritMoves) {
