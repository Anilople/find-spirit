...
public class JudgeUtilTest {
	...
	public void existEqualInAll() {
		assertTrue(JudgeUtil.existEqualInAll(Arrays.asList(1, 2, 3), Arrays.asList(Arrays.asList(3, 2, 1), Arrays.asList(1, 3, 3))));
		assertFalse(JudgeUtil.existEqualInAll(Arrays.asList(1, 2, 3), Arrays.asList(Arrays.asList(3, 3, 1), Arrays.asList(3, 2, 1), Arrays.asList(1, 3, 3))));
	}
